...
pub struct Config {
    ...
    pub judecoin_avg_block_time: Duration,
    pub judecoin_finality_confirmations: u64,
    #[serde(with = "judecoin_network")]
    pub judecoin_network: judecoin::Network,
}
...
impl Config {
    ...
    pub fn judecoin_sync_interval(&self) -> Duration {
        sync_interval(self.judecoin_avg_block_time)
    }
}
...
impl GetConfig for Mainnet {
    fn get_config() -> Config {
        Config {
            ...
            judecoin_avg_block_time: 2.std_minutes(),
            judecoin_finality_confirmations: 10,
            judecoin_network: judecoin::Network::Mainnet,
        }
    }
}
...
impl GetConfig for Testnet {
    fn get_config() -> Config {
        Config {
            ...
            judecoin_avg_block_time: 2.std_minutes(),
            judecoin_finality_confirmations: 10,
            judecoin_network: judecoin::Network::Stagenet,
        }
    }
}
...
impl GetConfig for Regtest {
    fn get_config() -> Config {
        Config {
            ...
            judecoin_avg_block_time: 1.std_seconds(),
            judecoin_finality_confirmations: 10,
            judecoin_network: judecoin::Network::Mainnet, // yes this is strange
        }
    }
}
...
pub fn new(is_testnet: bool, asb_config: &asb::config::Config) -> Config {
    ...
    if let Some(judecoin_finality_confirmations) = asb_config.judecoin.finality_confirmations {
        Config {
            judecoin_finality_confirmations,
            ..env_config
        }
    } else {
        env_config
...
mod judecoin_network {
    use crate::judecoin::Network;
    use serde::Serializer;

    pub fn serialize<S>(x: &judecoin::Network, s: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        let str = match x {
