...
pub trait Database {
    ...
    async fn insert_judecoin_address(&self, swap_id: Uuid, address: judecoin::Address) -> Result<()>;
    async fn get_judecoin_address(&self, swap_id: Uuid) -> Result<judecoin::Address>;
