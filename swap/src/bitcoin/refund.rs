...
impl TxRefund {
    ...
    pub fn extract_judecoin_private_key(
        ...
        let s_a = judecoin::PrivateKey { scalar: s_a };
        ...
        let s_b = bitcoin::recover(S_b_bitcoin, tx_refund_sig, tx_refund_encsig)
            .context("Failed to recover judecoin secret key from Bitcoin signature")?;

        let s_b = judecoin::private_key_from_secp256k1_scalar(s_b.into());
