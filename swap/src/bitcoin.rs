...
impl SecretKey {
    ...
    // TxLock_Bitcoin. S_a and S_b, are the judecoin Public Keys which go on the
    // joint output for TxLock_judecoin
    ...
    // alice now has s_a and s_b and can refund judecoin
...
mod tests {
    ...
    async fn calculate_transaction_weights() {
        ...
        let jude_amount = crate::judecoin::Amount::from_piconero(10000);
        ...
        let bob_state0 = bob::State0::new(
            ...
            config.judecoin_finality_confirmations,
            spending_fee,
            spending_fee,
        );
        ...
        let bob_state4 = bob_state3.jude_locked(judecoin_rpc::wallet::BlockHeight { height: 0 });
