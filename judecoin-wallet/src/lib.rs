...
use judecoin::consensus::encode::VarInt;
use judecoin::cryptonote::hash::Hashable;
use judecoin_rpc::judecoind;
use judecoin_rpc::judecoind::{GetBlockResponse, judecoindRpc as _};
use rand::Rng;
...
mod tests {
    use super::*;
    use judecoin_harness::image::judecoind;
    use judecoin_rpc::judecoind::{Client, GetOutputsOut};
    ...
    async fn get_outs_for_key_offsets() {
        let cli = Cli::default();
        let container = cli.run(judecoind::default());
